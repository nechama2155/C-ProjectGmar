...
import { myCustomersThunk } from "../../redux/slices/get/myCustomersThunk";
                    ...
                    return <tr key={d.customerId} onClick={() => { setSelected(true); setSelectedAs(d)}} className={(selected && selectedAs === d) ? "s" : "r"}>
                      ...
                      {!thisAssessor.isManager &&<>
                        ...
                        {/* <MailOutlineOutlinedIcon /> */}
                            ...
                            <Button variant="text" onClick={() => { navigate('/home/fullApplications') }}><GridViewIcon/>all applications</Button>
                            {/* } */}
