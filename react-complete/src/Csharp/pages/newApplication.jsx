    ...
    const cc = () => {
        ...
        return <div >
            ...
            {!personalDetails && !finish && <div>
                <TextField id="standard-basic" label="first name" variant="standard" onChange={(e) => setNewCustomer({ ...newCustomer, customerFirstName: e.target.value })}/>
            ...
            {finish &&<>
              <div>your application accepted seccessfuly</div>
              <Button></Button>
              </>
            }
{/* </dialog> */}
